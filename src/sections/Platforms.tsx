              ...
              >
                ...
                >
                  ...
                  <div className="mt-auto pt-8">
                    <div className="flex h-10 w-10 items-center justify-center border border-fg/10 text-fg/35 transition duration-300 group-hover:border-cyan-300/40 group-hover:text-cyan-300">
                      <Icon
                        size={18}
                        strokeWidth={1.5}
                        aria-hidden

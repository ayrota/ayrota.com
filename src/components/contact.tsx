...
const Contact = React.forwardRef<HTMLDivElement>((_props, ref) => {
  return (
    <section
      ...
      style={{ backgroundImage: `url('/kamyon.webp')` }}
    >
      ...
      <div className="relative z-10 text-center text-white p-8 container mx-auto">
        ...
        <div className="flex justify-center items-center">
          <a
            href="https://www.linkedin.com/company/ayrota"
            target="_blank"
        ...
        <div className="space-x-2 mb-16">
          <a className="text-lg text-white-100 hover:text-blue-200">
            contact [at] ayrota.com
          </a>
        </div>
